...
function App() {
  ...
  let levelTwo = [
    ...
    "What's your favorite song lyric you can thank of off the top of your head?",
    ...
    "What are you still trying to prove yourself?",
    ...
    "Whats the most pain you've ever been in that wasn't physical?",
